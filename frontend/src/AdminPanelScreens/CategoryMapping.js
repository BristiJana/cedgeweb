...
export default function CategoryMapping() {
  ...
  const[obj, setObj] = useState(['Deposit','Loan', 'other Assets']);
  const[obj2,setobj2]=useState(["Category","Sub-Category","Sub Details Category","Others"])
            ...
            <div className="card" style={{ width: "100%" }}>
              <div className="row clearfix">
                <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  ...
                  >
                    <h5>
                      <strong>List of Category Define</strong>
                    </h5>
          ...
          <table className="display table table-hover table-checkable order-column m-t-20 width-per-100 table-bordered">
            <thead>
              <tr>
                ...
                <th style={{ textAlign: "center" }}>Sub Category Parent </th>
              </tr>
            </thead>
