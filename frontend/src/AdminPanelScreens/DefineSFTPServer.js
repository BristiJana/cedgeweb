...
export default function DefineSFTPServer() {
  ...
  const handleUpload = (e) => {
    ...
    // Do something with the selected folder, e.g., upload it to a server.
  };
                    ...
                    <table className="mat-table" id="excel-table">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>Tenant Name</th>
                          <th></th>
                          <th>Is Multiple SFTP Definition</th>
                        </tr>
                      </thead>
                      <tbody>
                        {visibleData.map((row) => (
                          <tr key={row.id}>
                            ...
                            <td>{row.is_multiple_sftp_definition}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                    ...
                    <div className="body">
                      <div className="row clearfix">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-4">
                          ...
                          >
                            Tenant Name<em style={{ color: "red" }}>*</em>
                          </FormLabel>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-4">
                          <div className="form-group">
                            ...
                            <FormControlLabel
                              ...
                              label={
                                tenantonboardForm.is_legal_tenant ? "Yes" : "No"
                              }
                            />
                          </div>
                        </div>
